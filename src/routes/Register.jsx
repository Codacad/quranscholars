...
const Register = () => {
  ...
  return (
    <>
      <div className="relative register flex justify-center items-start md:items-center bg-gradient-to-br from-amber-50 via-white to-rose-50 px-4 py-6 md:p-12 min-h-[calc(100vh-140px)] overflow-hidden">
