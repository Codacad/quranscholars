  ...
  return (
    <>
      <div className="services p-px10p bg-orange-50 py-8 grid grid-cols-3 gap-6 font-guminert">
        ...
        <div className="service interactive-lesson border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service educational-resources border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service spiritual-development border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service community-engagement border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service personal-guidance border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service language-support border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service family-focus-services border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service youth-program border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
        ...
        <div className="service islamic-events border-2 border-orange-800 bg-orange-100 p-4 rounded-md ">
          <div className="flex flex-col items-center gap-2 text-center">
            <span>
