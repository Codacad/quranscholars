  ...
  return (
    <>
      <div className="courses bg-red-50 md:p-8">
        <div className="course-list-showcase rounded-xl md:order-2 p-4 bg-red-100 md:flex gap-4 items-center">
          <div className="text-content md:p-16 flex flex-col gap-6">
            ...
            <h1 className="text-4xl font-bold text-primary">Course List</h1>
        ...
        <div className="course-listing md:px-16">
