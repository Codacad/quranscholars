...
const Sidenav = () => {
  ...
  return (
    <>
      <nav className={`sidenav max-md:flex hidden fixed w-full h-full top-12 transition-all duration-200 ease-[cubic-bezier(.5,.67,.78,.68)] bg-[rgba(0,0,0,.6)] z-20 ${showSideNav ? "" : "opacity-0"}`}>
