    ...
    <>
      <div className="login min-h-screen md:p-px10p max-md:p-4 md:grid grid-cols-2 items-center justify-center">
        ...
        >
          ...
          <div className="email group flex border border-gray-400 rounded-lg items-center md:w-[80%]">
          ...
          <div className="email flex border border-gray-400 rounded-lg items-center md:w-[80%]">
          ...
          <button className="submit text-gray-100 bg-red-800 p-2 md:w-[80%] rounded-md">
            Login
          </button>
