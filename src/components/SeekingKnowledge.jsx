    ...
    <div className="seeking-knowledge min-h-[100vh] py-16 px-6 flex items-center">
      <div className="seeking-knowledge-content max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="image flex justify-center">
          <img className="w-full max-w-md rounded-lg" src={SeekingKnowledgeImg} alt="Seeking Knowledge" />
        </div>
        ...
        <div className="text flex flex-col justify-center items-start md:items-center text-center gap-6 md:px-8 md:py-2">
          ...
          <p className="leading-relaxed text-navlinks text-lg">
            ...
            This is obvious when one takes a look at the Quran and the traditions of Prophet Muhammad, which are filled with references to learning, education, and observation.
          </p>
          <button
            onClick={() => setReadMoreToggle(!readMoreToggle)}
            className="w-40 bg-red-600 text-white p-3 rounded-full mt-6 transform hover:scale-105 transition duration-200"
          >
            {readMoreToggle ? 'Read Less' : 'Read More'}
          </button>
        </div>
      </div>
