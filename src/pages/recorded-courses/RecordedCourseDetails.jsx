...
const RecordedCourseDetails = () => {
  ...
  if (!course) {
    return <main className="grid min-h-[60vh] place-items-center bg-[#fbfcfa] px-4"><div className="max-w-lg text-center"><span className="mx-auto grid size-12 place-items-center rounded-xl bg-[#e8f4f0] text-primary"><BookOpen /></span><h1 className="mt-5 font-display text-3xl font-black">Course not found</h1><p className="mt-3 text-[#68766f]">This self-paced course may have moved or is not currently published.</p><Link to="/courses" className="mt-6 inline-flex min-h-11 items-center gap-2 rounded-lg bg-primary px-5 text-sm font-black text-white no-underline"><ArrowLeft className="size-4" />Back to courses</Link></div></main>;
  }
